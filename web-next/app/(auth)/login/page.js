...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-300/10 flex flex-col items-center justify-center sm:p-8">
      <div className="bg-white sm:border shadow w-full sm:max-w-lg md:max-w-xl xl:max-w-6xl min-h-screen sm:min-h-[750px] flex flex-col xl:flex-row sm:rounded-2xl overflow-hidden">
        ...
        <div className="relative w-full p-8 flex flex-col flex-1 xl:flex-auto bg-white">
          <div className="flex flex-col gap-6 items-center justify-center mt-2 xl:mt-4">
            {/* sign in to your account and buttons */}
            <div
              className={`flex flex-col gap-4 items-center justify-center bg--500 ${
                globalMessage ? "mb-0" : "mb-8"
              }`}
            >
              <div className={`text-2xl font-semibold }`}>
                Sign in to your account
              </div>
              <div className="flex items-center w-full sm:w-3/4 gap-2 bg--500">
                <button
                  onClick={() => {
                    setLoginMethod("email");
                    resetFields();
                  }}
                  className={`px-4 py-2 rounded-lg transition-colors duration-150 w-full ${
                    loginMethod === "email"
